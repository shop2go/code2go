...
func Handler(w http.ResponseWriter, r *http.Request) {
	...
	case "GET":
		...
		<button type="submit" class="btn btn-success" style="font-size:30px;">Bezahlen</button><br>
		<p>per eps, Sofort., Debit-/Kreditkarte und PayPal.</p><br><p>Transaktionshandler:</p>
